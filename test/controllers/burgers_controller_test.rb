...
class BurgersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create burger" do
    assert_difference("Burger.count") do
      post burgers_url, params: { burger: { description: @burger.description, name: @burger.name, price: @burger.price } }
    end
  ...
  test "should update burger" do
    patch burger_url(@burger), params: { burger: { description: @burger.description, name: @burger.name, price: @burger.price } }
