...
class PromotionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promotion" do
    assert_difference("Promotion.count") do
      post promotions_url, params: { promotion: { active: @promotion.active, code: @promotion.code, discount: @promotion.discount } }
    end
  ...
  test "should update promotion" do
    patch promotion_url(@promotion), params: { promotion: { active: @promotion.active, code: @promotion.code, discount: @promotion.discount } }
